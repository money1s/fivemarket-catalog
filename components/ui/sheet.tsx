...
const sheetVariants = cva(
  "fixed z-50 grid gap-4 border border-border bg-background p-5 shadow-soft transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
