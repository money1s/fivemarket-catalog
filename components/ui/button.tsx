  ...
  "inline-flex min-h-11 min-w-11 items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        link: "h-auto min-h-0 min-w-0 rounded-none p-0 text-primary underline-offset-4 hover:underline",
      },
      size: {
        default: "px-4 py-2",
